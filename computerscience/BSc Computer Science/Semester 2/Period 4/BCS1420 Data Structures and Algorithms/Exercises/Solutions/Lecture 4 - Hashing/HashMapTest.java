...
public class HashMapTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Collisions: " + myHashMap.getCollisions());


        HashMap<String> newHashMap = new HashMap<String>();
        for(int i = 0; i < 5000; i++) {
            newHashMap.put(i, "Value "+i);
        }
        System.out.println("Collisions: " + newHashMap.getCollisions());
